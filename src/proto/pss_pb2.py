...
_DISTURBANCES = _descriptor.Descriptor(
  name='Disturbances',
  full_name='melody_powersim_proto.Disturbances',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='disturbance', full_name='melody_powersim_proto.Disturbances.disturbance', index=0,
...
_DISTURBANCES.fields_by_name['disturbance'].message_type = _WRITEREQUEST
...
Disturbances = _reflection.GeneratedProtocolMessageType('Disturbances', (_message.Message,), dict(
  ...
  __module__ = 'pss_pb2'
  # @@protoc_insertion_point(class_scope:melody_powersim_proto.Disturbances)
  ))
